...
public class GameGenerator {
    public static int[][] getNewGameGrid(){
        return unsolve(getSolvedGame());
    }

    private static int[][] unsolve(int[][] solvedGame) {
        ...
        while (!solvable){
            ...
            while(index < 40){
                ...
                if (solveableArray[xCoordinates][yCoordinates] != 0){
                    solveableArray[xCoordinates][yCoordinates] = 0;
                    index ++;
                }
            }
